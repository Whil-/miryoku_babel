...
KC_A,              KC_Z,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LT(U_BUTTON,KC_Q), KC_S,              KC_D,              KC_F,              KC_G,              KC_H,              KC_J,              KC_K,              KC_L,              LT(U_BUTTON,KC_M), \
LGUI_T(KC_W),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_V),      ALGR_T(KC_B),      ALGR_T(KC_N),      LSFT_T(KC_COMM),   LCTL_T(KC_DOT),    LALT_T(KC_SLSH),   LGUI_T(KC_QUOT),   \
...
KC_Q,              KC_H,              KC_O,              KC_U,              KC_X,              KC_G,              KC_C,              KC_R,              KC_F,              KC_Z,              \
LT(U_BUTTON,KC_Y), KC_I,              KC_E,              KC_A,              KC_DOT,            KC_D,              KC_S,              KC_T,              KC_N,              LT(U_BUTTON,KC_B), \
LGUI_T(KC_J),      LALT_T(KC_SLSH),   LCTL_T(KC_COMM),   LSFT_T(KC_K),      ALGR_T(KC_QUOT),   ALGR_T(KC_W),      LSFT_T(KC_M),      LCTL_T(KC_L),      LALT_T(KC_P),      LGUI_T(KC_V),      \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_G,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LT(U_BUTTON,KC_A), KC_R,              KC_S,              KC_T,              KC_D,              KC_H,              KC_N,              KC_E,              KC_I,              LT(U_BUTTON,KC_O), \
LGUI_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_V),      ALGR_T(KC_B),      ALGR_T(KC_K),      LSFT_T(KC_M),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LT(U_BUTTON,KC_A), KC_R,              KC_S,              KC_T,              KC_G,              KC_M,              KC_N,              KC_E,              KC_I,              LT(U_BUTTON,KC_O), \
LGUI_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_D),      ALGR_T(KC_V),      ALGR_T(KC_K),      LSFT_T(KC_H),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,           \
LT(U_BUTTON,KC_A), KC_R,              KC_S,              KC_T,              KC_G,              KC_K,              KC_N,              KC_E,              KC_I,              LT(U_BUTTON,KC_O), \
LGUI_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_D),      ALGR_T(KC_V),      ALGR_T(KC_M),      LSFT_T(KC_H),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
KC_QUOT,           KC_COMM,           KC_DOT,            KC_P,              KC_Y,              KC_F,              KC_G,              KC_C,              KC_R,              KC_L,              \
LT(U_BUTTON,KC_A), KC_O,              KC_E,              KC_U,              KC_I,              KC_D,              KC_H,              KC_T,              KC_N,              LT(U_BUTTON,KC_S), \
LGUI_T(KC_SLSH),   LALT_T(KC_Q),      LCTL_T(KC_J),      LSFT_T(KC_K),      ALGR_T(KC_X),      ALGR_T(KC_B),      LSFT_T(KC_M),      LCTL_T(KC_W),      LALT_T(KC_V),      LGUI_T(KC_Z),      \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
KC_W,              KC_L,              KC_R,              KC_B,              KC_Z,              KC_QUOT,           KC_Q,              KC_U,              KC_D,              KC_J,              \
LT(U_BUTTON,KC_S), KC_H,              KC_N,              KC_T,              KC_COMM,           KC_DOT,            KC_A,              KC_E,              KC_O,              LT(U_BUTTON,KC_I), \
LGUI_T(KC_F),      LALT_T(KC_M),      LCTL_T(KC_V),      LSFT_T(KC_C),      ALGR_T(KC_SLSH),   ALGR_T(KC_G),      LSFT_T(KC_P),      LCTL_T(KC_X),      LALT_T(KC_K),      LGUI_T(KC_Y),      \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
KC_Q,              KC_D,              KC_R,              KC_W,              KC_B,              KC_J,              KC_F,              KC_U,              KC_P,              KC_QUOT,           \
LT(U_BUTTON,KC_A), KC_S,              KC_H,              KC_T,              KC_G,              KC_Y,              KC_N,              KC_E,              KC_O,              LT(U_BUTTON,KC_I), \
LGUI_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_M),      LSFT_T(KC_C),      ALGR_T(KC_V),      ALGR_T(KC_K),      LSFT_T(KC_L),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,              \
LT(U_BUTTON,KC_A), KC_S,              KC_D,              KC_F,              KC_G,              KC_H,              KC_J,              KC_K,              KC_L,              LT(U_BUTTON,KC_QUOT),\
LGUI_T(KC_Z),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_V),      ALGR_T(KC_B),      ALGR_T(KC_N),      LSFT_T(KC_M),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,              KC_Z,              KC_U,              KC_I,              KC_O,              KC_P,              \
LT(U_BUTTON,KC_A), KC_S,              KC_D,              KC_F,              KC_G,              KC_H,              KC_J,              KC_K,              KC_L,              LT(U_BUTTON,KC_QUOT),\
LGUI_T(KC_Y),      LALT_T(KC_X),      LCTL_T(KC_C),      LSFT_T(KC_V),      ALGR_T(KC_B),      ALGR_T(KC_N),      LSFT_T(KC_M),      LCTL_T(KC_COMM),   LALT_T(KC_DOT),    LGUI_T(KC_SLSH),   \
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_BSPC), LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_SPC),  LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            KC_INS,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_SPC,            KC_DEL,            U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
RESET,             DF(U_TAP),         DF(U_EXTRA),       DF(U_BASE),        U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NA,              U_NA,              DF(U_NUM),         DF(U_NAV),         U_NA,              KC_CAPS,           KC_LEFT,           KC_DOWN,           KC_UP,             KC_RGHT,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           KC_INS,            KC_HOME,           KC_PGDN,           KC_PGUP,           KC_END,            \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_ENT,            KC_SPC,            KC_DEL,            U_NP,              U_NP
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_MOUSE \
RESET,             DF(U_TAP),         DF(U_EXTRA),       DF(U_BASE),        U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NA,              U_NA,              DF(U_SYM),         DF(U_MOUSE),       U_NA,              U_NU,              KC_MS_L,           KC_MS_D,           KC_MS_U,           KC_MS_R,           \
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           U_NU,              KC_WH_L,           KC_WH_D,           KC_WH_U,           KC_WH_R,           \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_BTN2,           KC_BTN1,           KC_BTN3,           U_NP,              U_NP
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           OUT_AUTO,          U_NU,              U_NU,              U_NU,              U_NU,              \
...
KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           KC_ALGR,           U_NU,              U_NU,              U_NU,              U_NU,              OUT_AUTO,          \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              KC_MSTP,           KC_MPLY,           KC_MUTE,           U_NP,              U_NP
...
KC_GRV,            KC_1,              KC_2,              KC_3,              KC_BSLS,           KC_ALGR,           KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
KC_TILD,           KC_EXLM,           KC_AT,             KC_HASH,           KC_PIPE,           KC_ALGR,           KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
...
KC_F10,            KC_F1,             KC_F2,             KC_F3,             KC_PAUS,           KC_ALGR,           KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,           \
