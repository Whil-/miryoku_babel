...
U_NP,              U_NP,              U_LT(del, U_FUN),  U_LT(spc, U_NUM),  U_LT(ent, U_SYM),  U_LT(tab, U_MOUSE),U_LT(bspc, U_NAV), U_LT(esc, U_MEDIA),U_NP,              U_NP
...
a,                 z,                 e,                 r,                 t,                 y,                 u,                 i,                 o,                 p,                 \
U_LT(q, U_BUTTON), s,                 d,                 f,                 g,                 h,                 j,                 k,                 l,                 U_LT(m, U_BUTTON), \
U_MT(w, met),      U_MT(x, alt),      U_MT(c, ctl),      U_MT(v, sft),      U_MT(b, ralt),     U_MT(n, ralt),     U_MT(U_COMM, sft), U_MT(., ctl),      U_MT(/, alt),      U_MT(U_QUOT, met), \
...
q,                 h,                 o,                 u,                 x,                 g,                 c,                 r,                 f,                 z,                 \
U_LT(y, U_BUTTON), i,                 e,                 a,                 .,                 d,                 s,                 t,                 n,                 U_LT(b, U_BUTTON), \
U_MT(j, met),      U_MT(/, alt),      U_MT(U_COMM, ctl), U_MT(k, sft),      U_MT(U_QUOT, ralt),U_MT(w, ralt),     U_MT(m, sft),      U_MT(l, ctl),      U_MT(p, alt),      U_MT(v, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAK \
q,                 w,                 f,                 p,                 g,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_LT(a, U_BUTTON), r,                 s,                 t,                 d,                 h,                 n,                 e,                 i,                 U_LT(o, U_BUTTON), \
U_MT(z, met),      U_MT(x, alt),      U_MT(c, ctl),      U_MT(v, sft),      U_MT(b, ralt),     U_MT(k, ralt),     U_MT(m, sft),      U_MT(U_COMM, ctl), U_MT(., alt),      U_MT(/, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH \
q,                 w,                 f,                 p,                 b,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_LT(a, U_BUTTON), r,                 s,                 t,                 g,                 m,                 n,                 e,                 i,                 U_LT(o, U_BUTTON), \
U_MT(z, met),      U_MT(x, alt),      U_MT(c, ctl),      U_MT(d, sft),      U_MT(v, ralt),     U_MT(k, ralt),     U_MT(h, sft),      U_MT(U_COMM, ctl), U_MT(., alt),      U_MT(/, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_COLEMAKDHK \
q,                 w,                 f,                 p,                 b,                 j,                 l,                 u,                 y,                 U_QUOT,            \
U_LT(a, U_BUTTON), r,                 s,                 t,                 g,                 k,                 n,                 e,                 i,                 U_LT(o, U_BUTTON), \
U_MT(z, met),      U_MT(x, alt),      U_MT(c, ctl),      U_MT(d, sft),      U_MT(v, ralt),     U_MT(m, ralt),     U_MT(h, sft),      U_MT(U_COMM, ctl), U_MT(., alt),      U_MT(/, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_DVORAK \
U_QUOT,            U_COMM,            .,                 p,                 y,                 f,                 g,                 c,                 r,                 l,                 \
U_LT(a, U_BUTTON), o,                 e,                 u,                 i,                 d,                 h,                 t,                 n,                 U_LT(s, U_BUTTON), \
U_MT(/, met),      U_MT(q, alt),      U_MT(j, ctl),      U_MT(k, sft),      U_MT(x, ralt),     U_MT(b, ralt),     U_MT(m, sft),      U_MT(w, ctl),      U_MT(v, alt),      U_MT(z, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_HALMAK \
w,                 l,                 r,                 b,                 z,                 U_QUOT,            q,                 u,                 d,                 j,                 \
U_LT(s, U_BUTTON), h,                 n,                 t,                 U_COMM,            .,                 a,                 e,                 o,                 U_LT(i, U_BUTTON), \
U_MT(f, met),      U_MT(m, alt),      U_MT(v, ctl),      U_MT(c, sft),      U_MT(/, ralt),     U_MT(g, ralt),     U_MT(p, sft),      U_MT(x, ctl),      U_MT(k, alt),      U_MT(y, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_WORKMAN \
q,                 d,                 r,                 w,                 b,                 j,                 f,                 u,                 p,                 U_QUOT,            \
U_LT(a, U_BUTTON), s,                 h,                 t,                 g,                 y,                 n,                 e,                 o,                 U_LT(i, U_BUTTON), \
U_MT(z, met),      U_MT(x, alt),      U_MT(m, ctl),      U_MT(c, sft),      U_MT(v, ralt),     U_MT(k, ralt),     U_MT(l, sft),      U_MT(U_COMM, ctl), U_MT(., alt),      U_MT(/, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTY \
q,                 w,                 e,                 r,                 t,                 y,                 u,                 i,                 o,                 p,                 \
U_LT(a, U_BUTTON), s,                 d,                 f,                 g,                 h,                 j,                 k,                 l,                 U_LT(U_QUOT, U_BUTTON),\
U_MT(z, met),      U_MT(x, alt),      U_MT(c, ctl),      U_MT(v, sft),      U_MT(b, ralt),     U_MT(n, ralt),     U_MT(m, sft),      U_MT(U_COMM, ctl), U_MT(., alt),      U_MT(/, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_BASE_QWERTZ \
q,                 w,                 e,                 r,                 t,                 z,                 u,                 i,                 o,                 p,                 \
U_LT(a, U_BUTTON), s,                 d,                 f,                 g,                 h,                 j,                 k,                 l,                 U_LT(U_QUOT, U_BUTTON),\
U_MT(y, met),      U_MT(x, alt),      U_MT(c, ctl),      U_MT(v, sft),      U_MT(b, ralt),     U_MT(n, ralt),     U_MT(m, sft),      U_MT(U_COMM, ctl), U_MT(., alt),      U_MT(/, met),      \
U_NP,              U_NP,              U_LT(esc, U_MEDIA),U_LT(bspc, U_NAV), U_LT(tab, U_MOUSE),U_LT(ent, U_SYM),  U_LT(spc, U_NUM),  U_LT(del, U_FUN),  U_NP,              U_NP
...
U_NP,              U_NP,              del,               spc,               ent,               tab,               bspc,              esc,               U_NP,              U_NP
...
met,               alt,               ctl,               sft,               ralt,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
...
met,               alt,               ctl,               sft,               ralt,              home,              pgdn,              pgup,              end,               ins,               \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ent,               spc,               del,               U_NP,              U_NP

#define MIRYOKU_ALTERNATIVES_NAV \
U_NA,              U_DF(U_TAP),       U_DF(U_EXTRA),     U_DF(U_BASE),      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
U_NA,              U_NA,              U_DF(U_NUM),       U_DF(U_NAV),       U_NA,              caps,              left,              down,              up,                right,             \
met,               alt,               ctl,               sft,               ralt,              ins,               home,              pgdn,              pgup,              end,               \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              ent,               spc,               del,               U_NP,              U_NP
...
met,               alt,               ctl,               sft,               ralt,              U_NU,              U_NU,              U_NU,              U_NU,              U_NU,              \
U_NP,              U_NP,              U_NA,              U_NA,              U_NA,              #(kp- kp5),        #(kp/ kp5),        #(kp* kp5),        U_NP,              U_NP
...
f10,               f1,                f2,                f3,                pause,             ralt,              sft,               ctl,               alt,               met,               \
