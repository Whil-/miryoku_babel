...
#+NAME: thumbs
| DF(U_TAP) | LCTL | DEL | BSPC | TAB | ENT | SPC | ESC | LCTL | DF(U_BASE) |


**** Hold

#+NAME: hold
| BOOT | LGUI | LALT     | LCTL     | ALGR    | ALGR  | LCTL     | LALT     | LGUI | BOOT |
| LSFT | U_NA | U_NA     | U_NA     |         |       | U_NA     | U_NA     | U_NA | LSFT |
| U_NA | U_NA | LOCK_OPP | LOCK_CUR |         |       | LOCK_CUR | LOCK_OPP | U_NA | U_NA |
| U_NP | LCTL | U_MEDIA  | U_NAV    | U_MOUSE | U_SYM | U_NUM    | U_FUN    | LCTL | U_NP |
...
|       | MS_L  | MS_D  | MS_U  | MS_R       |
|       | WH_L  | WH_D  | WH_U  | WH_R       |
| BTN1  | BTN3  | BTN2  | LCTL  | DF(U_BASE) |

*** Button

#+NAME: button
| U_UND | U_CUT | U_CPY | U_PST | U_RDO | U_RDO | U_PST | U_CPY | U_CUT | U_UND |
| LSFT  | LGUI  | LALT  | LCTL  |       |       | LCTL  | LALT  | LGUI  | LSFT  |
| U_UND | U_CUT | U_CPY | U_PST | U_RDO | U_RDO | U_PST | U_CPY | U_CUT | U_UND |
